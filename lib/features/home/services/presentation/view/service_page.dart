...
import 'package:portal1409/features/home/services/data/data.dart';
          ...
          children: [
            ...
            IconButton(
              onPressed: () => context.router.push(
                AccountRoute(heroTag: HeroTags.fromServiceToAccount),
              ),
              icon: Hero(
              ...
              ...services.entries.expand((service) {
                return [
                  BasicCard(
                    ...
                    func: service.value["func"] is Function
                        ? service.value["func"]
                        : () => context.router.pushPath(service.value["func"]),
        ...
        if (i.toString() == list[l]) {
          ...
          result.add(
            BasicCard(
              ...
              func: func is String ? () => context.router.pushPath(func) : func,
