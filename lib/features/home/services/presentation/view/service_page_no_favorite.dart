...
import 'package:portal1409/features/home/services/data/service_data.dart';
              ...
              ...services.entries.expand((service) {
                return [
                  ...
                  BasicCard(
                    ...
                    func: service.value["func"] is Function ? service.value["func"] : () => context.router.pushPath(service.value["func"]),
