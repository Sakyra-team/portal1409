...
const String guestPassUrl = "$basicUrl/create_guest_pass"; // Пропуск для гостя u
const String cardsRequestsUrl = "$barinUrl/admin/card-applications"; // Заявки на карты
const String eventsUrl = "$basicUrl/events"; // Мероприятия
const String radioUrl = "$basicUrl/scheduled-announcements/admin"; // Радио
const String bellsUrl = "$basicUrl/bells/admin"; // Звонки
const String announcerUrl = "$basicUrl/announcer/admin"; // Громкая связь
const String newsUrl = "$basicUrl/admin/news"; // Новости
...
const String sportsmanRegeditUrl = "$basicUrl/athlete_permissions"; // Реестр спортсменов 

// new

const String slushebka = "$basicUrl/official-notes";
const String forms = "$basicUrl/forms";
const String tasks = "$basicUrl/tasks";
