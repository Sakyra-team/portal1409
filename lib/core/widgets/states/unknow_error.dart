    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            "В приложении критическая ошибка. Необходима перезагрузка приложения. Вы можете воспользоватся сайтов my1409.ru как временное решение. Отправьте данные об ошибке разработчику нажак кнопку снизу",
            textAlign: .center,
            softWrap: true,
          ),
          const SizedBox(height: 8),
